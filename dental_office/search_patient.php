...
<body style="background-color: rgba(71, 147, 227, 1)" ;>
 ...
 pc.patient_state as state, pc.patient_zip as zip, pi.email as email from
  ...
  where pi.first_name like '%$searchtext%' or pi.last_name like '%$searchtext%';";
 ...
 ?>
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $row['street'] . " " . $row['city'] . " " . $row['state'] . " " . $row['zip']; ?>
                        </td>
                        <td><a href="edit_patient.php?patient_id=<?php echo $row['patient_id']; ?>">Edit</a>&nbsp;
                            <a href="delete_patient.php?patient_id=<?php echo $row['patient_id']; ?>">Delete</a>
                        </td>
                    </tr>
                </tbody>
                <?php 
